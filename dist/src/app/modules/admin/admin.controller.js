...
const getAllVendorsData = catchAsync(async (req, res) => {
...
const getAllCustomersData = catchAsync(async (req, res) => {
...
const getPendingCertifications = catchAsync(async (req, res) => {
...
// Content Moderation
const getPendingProduces = catchAsync(async (req, res) => {
...
const getRentalAnalytics = catchAsync(async (req, res) => {
...
// System Settings
const getRateLimitLogs = catchAsync(async (req, res) => {
    const options = pick(req.query, ['limit', 'page', 'sortBy', 'sortOrder']);
