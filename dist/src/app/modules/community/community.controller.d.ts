...
export declare const CommunityController: {
    ...
    getPostById: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
    ...
    toggleLike: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
    addComment: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
    getPostComments: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
