 ...
 */
router.post('/:id/photos', auth(UserRole.Customer, UserRole.Vendor), PlantTrackingController.uploadPhotos);
/**
 * @swagger
 ...
 */
router.post('/:id/growth', auth(UserRole.Customer, UserRole.Vendor), PlantTrackingController.recordGrowth);
/**
 * @swagger
 * /plant-tracking/{id}:
 *   delete:
