 ...
 */
router.post('/rental-spaces', (0, auth_1.default)(common_1.UserRole.Vendor), uploadSingle, uploadToCloudinary, vendor_controller_1.VendorController.createRentalSpace);
/**
 * @swagger
 * /vendor/rental-spaces:
 *   get:
 ...
 */
router.patch('/rental-spaces/:id', (0, auth_1.default)(common_1.UserRole.Vendor), vendor_controller_1.VendorController.updateRentalSpace);
/**
 * @swagger
 * /vendor/rental-spaces/{id}:
 *   delete:
 ...
 */
router.patch('/produces/:id', (0, auth_1.default)(common_1.UserRole.Vendor), vendor_controller_1.VendorController.updateProduce);
/**
 * @swagger
 * /vendor/produces/{id}:
 *   delete:
